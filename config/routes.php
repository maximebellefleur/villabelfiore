...
$router->get('/settings/item-types',           'SettingsController@itemTypes');
$router->post('/settings/item-types/add',      'SettingsController@addItemType');
$router->post('/settings/item-types/{key}/delete', 'SettingsController@deleteItemType');
...
$router->get('/settings/menus',               'SettingsController@menus');
$router->post('/settings/menus/save',          'SettingsController@saveMenus');
...
$router->post('/items/{id}/lines/set-sown',         'GardenBedController@setLineSown');
$router->post('/garden/plantings/reorder',           'GardenBedController@reorderPlantings');
