...
<form method="GET" action="<?= url('/items') ?>" class="filter-bar">
    ...
    <a href="<?= url('/items') ?>" class="btn btn-link">Clear</a>
</form>

<?php if (empty($items)): ?>
<div class="empty-state">
    <p>No items found. <a href="<?= url('/items/create') ?>">Add your first item</a>.</p>
</div>
<?php else: ?>
<div class="card-list">
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title">
                <a href="<?= url('/items/' . ((int)$item['id'])) ?>"><?= e($item['name']) ?></a>
        ...
        <div class="card-actions">
            <a href="<?= url('/items/' . ((int)$item['id']) . '/edit') ?>" class="btn btn-sm btn-secondary">Edit</a>
            ...
            <?php else: ?>
            <form method="POST" action="<?= url('/items/' . ((int)$item['id']) . '/restore') ?>" style="display:inline">
                <input type="hidden" name="_token" value="<?= e(\App\Support\CSRF::getToken()) ?>">
